<template>
  <div>
    <div class="grid-container">
      <div class="title">
        <h1 class="text-center font-weight-bold text-yellow">UNIVERSITY DEPARMENTS</h1>
      ...
      <main class="grid-item main">
        <div class="items" ref="horizontal" @mousedown="onMouseDown" @mousemove="onMouseMove" @mouseup="onMouseUp">
          ...
          <div id="introcard" class="item item1" v-tilt="{ perspective: 500}" v-for="(dep, i) in departments" :key="i">
            <img id="introcard" src="@/assets/images/university-section.jpg" alt="">
            <div class="introcard-description">
              <h6>Click to learn more about this unit/department.</h6>
            </div>
            <div class="introcard-button">
              <a href="" class="btn rounded-pill btn-primary">{{dep.unit}}</a>
            </div>
          </div>
        </div>
      </main>
